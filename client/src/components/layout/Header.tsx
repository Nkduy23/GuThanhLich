      ...
      <div className="mx-auto max-w-7xl px-4 flex items-center justify-between py-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <input type="text" placeholder="Tìm kiếm..." className="rounded-md border border-gray-300 px-3 py-1 text-black focus:outline-none focus:ring-2 focus:ring-blue-400" />
          ...
          {token ? (
            <>
              <Link to="/profile" className="hover:text-gray-200 text-xl">
                ...
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g id="SVGRepo_iconCarrier">
                    {" "}
                    <circle cx="12" cy="6" r="4" fill="#272626"></circle> <path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" fill="#272626"></path>{" "}
                  </g>
                </svg>
              </Link>
              <button onClick={logout} className="hover:text-gray-200 text-xl">
                ...
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17 16L21 12M21 12L17 8M21 12H9M13 16V17C13 18.6569 11.6569 20 10 20H6C4.34315 20 3 18.6569 3 17V7C3 5.34315 4.34315 4 6 4H10C11.6569 4 13 5.34315 13 7V8" stroke="#272626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            ...
            <>
              <Link to="/login" className="hover:text-gray-200 text-xl">
                ...
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" stroke="#272626" strokeWidth="1.5" />
                </svg>
              </Link>
              <Link to="/cart" className="hover:text-gray-200 text-xl">
                {/* SVG Cart */}
