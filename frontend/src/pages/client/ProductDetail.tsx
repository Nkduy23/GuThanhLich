      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="lg:sticky lg:top-8 h-fit space-y-6">
          ...
          {selectedVariant?.sizes && selectedVariant.sizes.length > 0 && (
            ...
            ${selectedSize === s.size ? "border-blue-500 bg-blue-50 text-blue-600" : "border-gray-200 text-gray-900"}
            ${s.quantity === 0 ? "opacity-50 cursor-not-allowed" : "hover:border-blue-400 hover:bg-blue-50"}
          `}
